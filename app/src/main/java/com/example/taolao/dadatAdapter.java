...
public class dadatAdapter extends BaseAdapter {
    private Context context;
    private int layout;
    private List<dadat> dadatList;

    public dadatAdapter(Context context, int layout, ArrayList<dadat> dadatList) {
